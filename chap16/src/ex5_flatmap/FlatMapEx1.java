 ...
 *                                         double형을 매개변수입력받아 DoubleStream으로 리턴
 *  IntStream flatMap(IntFunction<IntStream>) : int형 매개변수로 입력받아 IntStream으로 리턴
...
public class FlatMapEx1 {
	public static void main(String[] args) {
		...
		//Stream<String> 요소가 3개=> Stream<String> 요소가 7개인 변환
